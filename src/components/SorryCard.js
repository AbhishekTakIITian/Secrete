        ...
        >
          <div className="card-front">
            ...
            {isMobile ? 
              ...
              <p className="flip-instruction">Hover to open ❤️‍🩹</p>
            }
          </div>
            ...
            <div className="card-content">
              ...
              <div className="scroll-content">
                <p className="card-text">
                  I know words might not be enough, but my heart aches knowing 
                  I've hurt you. You mean everything to me, and seeing you sad 
                  because of my actions breaks my heart.
                </p>
                <p className="card-text">
                  I know mi samjun nahi ghetla tula (tuzya peksha thoda kami samjutdar ahe na mi), majh chukla ani mi jara vichar nahi kela. 
